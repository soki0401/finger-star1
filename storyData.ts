...
export const STORY_BANK: StoryQuestion[] = [
  {
    ...
    star: "無",
    title: "未知的起點",
    image: "https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&q=80&w=1200", // 此處應為用戶提供的光芒草圖
    description: "你掉到一個未知的黑暗地方，四周迷霧繚繞，唯有前面的一束光閃爍著，似乎是唯一一個出口。",
    options: [
      { text: "憑什麼要我出去？", type: "A", immediateEnding: 1 },
      { text: "故事開始好像都要順著光走...", type: "B" },
      { text: "不出去，我就躺平。", type: "C", immediateEnding: 1 }
    ]
  },
  {
    palace: "命宮",
  ...
  },
  {
    ...
    options: [
      { text: "名為英雄的披風 (名聲)", type: "A" },
      { text: "百戰百勝的劍 (戰鬥)", type: "B" },
      { text: "無盡底的錢包 (物慾)", type: "C" }
    ]
  },
  {
    palace: "父母宮",
    ...
    options: [
      { text: "熱心幫忙清理乾淨", type: "A" },
      { text: "簡單把青苔弄下便繼續休息", type: "B" },
      { text: "這什麼石像啊，無視好了", type: "C" }
    ]
  },
  {
    palace: "父母宮",
    ...
    options: [
      { text: "大口吃掉", type: "A" },
      { text: "留著以後不時之需", type: "B" },
      { text: "送給路邊乞丐，狗都不吃陌生人的禮物", type: "C" }
    ]
  },
  {
    palace: "福德宮",
    ...
    options: [
      { text: "我還不吃爆 (擺爛支線)", type: "A" },
      { text: "先婉拒，太來路不明了吧", type: "B" },
      { text: "搶她的來吃", type: "C" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: "積極快地去幫忙整理", type: "A" },
      { text: "稍微簡單弄就好", type: "B" },
      { text: "乾脆直接出去淋雨", type: "C" }
    ]
  },
  {
    palace: "田宅宮",
  ...
  },
  {
    ...
    options: [
      { text: "反駁聲音，相信自己所見", type: "A" },
      { text: "保持沉默，冷靜分析", type: "B" },
      { text: "直接發瘋，開始亂吼", type: "C" }
    ]
  },
  {
    palace: "奴僕宮",
  ...
  },
  {
    ...
    options: [
      { text: "相信直覺衝進去就對了", type: "A" },
      { text: "嘗試幫她", type: "B" },
      { text: "算了，消失就消失", type: "C" }
    ]
  },
  {
    palace: "遷移宮",
    ...
    options: [
      { text: "人生就是賭博", type: "A" },
      { text: "先隨便丟個東西測試吧", type: "B" },
      { text: "等它穩定吧，不然感覺試試就逝逝", type: "C" }
    ]
  },
  {
    palace: "疾厄宮",
    ...
    options: [
      { text: "原諒，她只是想幫我而已", type: "A" },
      { text: "再看看吧", type: "B" },
      { text: "不原諒，她害我跑這麼累", type: "C" }
    ]
  },
  {
    palace: "疾厄宮",
  ...
  },
  {
    ...
    description: " 喝下飲品後一陣暈眩，再次睜眼時自己已經在外了。坐起身看著四周，這裡似乎是一個花園，身旁坐著一個女孩，見我清醒她很高興地說道「太好了，你終於醒啦！你剛剛忽出現這裡，好像中毒了，就先幫你解毒了。」。她說她叫太陰，我想感謝她為我解毒，但被拒絕了，推拖不下，便只邀請我與她一同在月光下散步。散步隨口聊著，她問：「你對月亮的想法是什麼呢？我很好奇。」",
    options: [
      { text: "月色很美", type: "A" },
      { text: "比起月亮更喜歡太陽", type: "B" },
      { text: "覺得沒什麼意思", type: "C" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: "頂著這些炙熱去找她", type: "A" },
      { text: "拿貪狼擋在前面", type: "B" },
      { text: "太亮了我先躲一下", type: "C" }
    ]
  },
  {
    palace: "夫妻宮",
  ...
  },
  {
    ...
    options: [
      { text: "與他決鬥", type: "A" },
      { text: "反正先求饒應該沒錯", type: "B" },
      { text: "拿出之前巨門落下的鑰匙", type: "C" }
    ]
  },
  {
    palace: "身宮",
...
export const STORY_ENDINGS: StoryEnding[] = [
  { id: 1, name: "站著不如躺著吧", description: "意志消磨，身體化為石碑，成為後人的路標。", meaning: "選擇了最安靜的路，也留下了最沈重的印記。" },
  { id: 2, name: "你好像很隨便 ㄟ...", description: "靈魂因失去自我而變輕，被星際狂風吹散成塵埃。", meaning: "在無盡的隨意中，妳也失去了存在的質量。" },
  { id: 3, name: "天倫之樂，有何不淪", description: "成為星圖裡的專屬食客，永遠不用工作但也無法回家。", meaning: "甜美的陷阱也是家，只要妳不再想念故鄉。" },
  { id: 4, name: "NPC 就是你喔^^", description: "喪失主角光環，成為星曜身邊永世的提包隨從。", meaning: "依附強者雖安穩，卻再也聽不見自己的心跳。" },
  { id: 5, name: "做夢也好", description: "靈魂被慾望吞噬，活在虛假 but 華麗的幻象中。", meaning: "真實有時醜陋，但那是妳唯一活過的證明。" },
  { id: 6, name: "辯論美食家", description: "回到現實後變得毒舌多疑，人際關係徹底崩碎。", meaning: "言詞是劍，傷人的同時也切斷了自己的連結。" },
  { id: 7, name: "破碎之靈", description: "回到現實後性格大變，成為無法控制情緒的火藥桶。", meaning: "破壞之後，留下的只有滿地無法修補的碎片。" },
  { id: 8, name: "躲貓貓上癮", description: "雖然平安回歸，但在現實中徹底失去存在感。", meaning: "過度的隱蔽，最終讓妳成為了自己的鬼魂。" },
  { id: 9, name: "決鬥吧！就你和我", description: "留在星圖中成為受人敬畏的戰神，但終生孤獨。", meaning: "最強的戰士，往往擁有最寂寞的脊樑。" },
  { id: 10, name: "難不成我洞悉了宇宙", description: "取代紫微星成為新任統治者，但也承擔了永恆束縛。", meaning: "王冠很重，戴上它的人將失去自由。" },
  { id: 11, name: "混沌祭典", description: "成為迷宮管理員，維護宇宙命盤的平衡運行。", meaning: "在混亂中尋找秩序，本身就是一種偉大的代價。" },
  { id: 12, name: "平凡的幸福", description: "成為星圖的後勤總管，所有主星都要禮讓你三分。", meaning: "看透了繁華，才懂得平凡的可貴。" },
  { id: 13, name: "財富自由（恭喜你發大財！）", description: "炸毀現實與虛擬的邊界，成為穿梭兩界的混亂者。", meaning: "當規則不再限制妳，妳就是唯一的真理。" },
  { id: 14, name: "命運之輪", description: "看破紅塵，隱居深山不再參與世俗。", meaning: "完美的平衡，是妳對命運最安靜的反擊。" },
  { id: 15, name: "烈焰給予你的", description: "明白平凡可貴，回到現實過著知足常樂的生活。", meaning: "經歷過烈火的洗禮，溫潤的靈魂更加堅韌。" }
];
